 ...
 */
public class ActividadManzanilla extends Activity {
    /** Called when the activity is first created. */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_actmanzanilla);
    ...
    public void onBackPressed() {
        //moveTaskToBack(true);
        super.onBackPressed();
        ActividadManzanilla.this.finish();
    }
    ...
    class obtenerHTML extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            HttpGet request = new HttpGet("http://www.losvinosdejerez.com/productos.php?id=13");
